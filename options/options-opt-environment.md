---
title: "How to Use the Environment Manager in WordPress"
...
> Configure environment-specific settings in Classic Monks. Set different configurations for production, staging, and development environments.
...
Different environments need different settings (debug on dev, caching on production). The Environment Manager lets you configure settings per environment.
