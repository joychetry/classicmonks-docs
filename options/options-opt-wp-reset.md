---
title: "How to Use WP Reset in WordPress"
slug: opt-wp-reset
...
> Reset the WordPress database to a fresh install state. Useful for development and staging sites.
...
For development sites, resetting the database to a fresh install state is faster than rebuilding from scratch.
