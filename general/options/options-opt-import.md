...
author: Joy
reading_time: 3 min
canonical: https://classicmonks.com/docs/options/opt-import/
---

# How to Import Settings in WordPress

> Import Classic Monks settings from a JSON file. Quickly configure a new site by importing settings from an existing one.
...
Setting up Classic Monks on a new site from scratch is time-consuming. Importing settings from an existing site saves hours of configuration.
