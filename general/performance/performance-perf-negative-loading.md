...
> Negative Loading in Classic Monks loads images before they enter the viewport (negative loading margin). This prevents a flash of unloaded content when the user scrolls quickly.
...
Without negative loading, images may appear blank for a moment when the user scrolls quickly. Negative loading preloads images slightly before they become visible.
...
Users who scroll quickly may see blank spaces before images load. Negative loading prevents this.

### Image galleries

In image galleries, negative loading ensures images are ready before the user scrolls to them.
