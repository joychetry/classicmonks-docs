...
slug: performance/perf-svg-support
...
author: Joy
reading_time: 3 min
canonical: https://classicmonks.com/docs/performance/perf-svg-support/
---

# How to Enable SVG Support in WordPress

> SVG Support in Classic Monks enables SVG file uploads to the WordPress Media Library. Allows SVG files to be uploaded, displayed, and used like any other image format.
...
WordPress blocks SVG uploads by default for security reasons. SVG Support lets you upload SVGs while maintaining security through sanitization.
...
SVG logos are crisp at any size and load faster than raster formats. SVG Support lets you upload them to the Media Library.

### Icon systems

SVG icons are smaller and more scalable than font icons. SVG Support enables SVG icon uploads.
