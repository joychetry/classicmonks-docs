...
slug: performance/perf-disable-image-sizes
...
author: Joy
reading_time: 3 min
canonical: https://classicmonks.com/docs/performance/perf-disable-image-sizes/
---

# How to Disable Unnecessary Image Sizes in WordPress

> Disable Unnecessary Image Sizes in Classic Monks prevents WordPress from generating specific image sizes. Saves disk space and reduces database entries.
...
WordPress generates multiple image sizes (thumbnail, medium, medium_large, large) by default. If you don't use certain sizes, they consume disk space unnecessarily.
...
### Sites with custom sizes

If you've registered custom sizes and don't need the default sizes, disabling them saves disk space.

### Performance optimization

Fewer image sizes mean fewer database entries and faster backups.
...
- `intermediate_image_sizes` calls `cm_disable_unwanted_image_sizes()` (Removes selected intermediate image sizes)

```php
// Hooked in media-functions.php
add_filter( 'intermediate_image_sizes', 'cm_disable_unwanted_image_sizes' );
```
