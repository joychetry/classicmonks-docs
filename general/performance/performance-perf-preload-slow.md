---
title: "How to Enable Preloading on Slow Connections in WordPress | CM"
slug: performance/perf-preload-slow
description: "Enable intelligent preloading for slow network connections in Classic Monks. Preloads pages for visitors on slow networks."
last_updated: 2026-06-24
author: Joy
reading_time: 3 min
canonical: https://classicmonks.com/docs/performance/perf-preload-slow/
---

# How to Enable Preloading on Slow Connections in WordPress

> Enable Preloading on Slow Connections in Classic Monks enables intelligent preloading specifically for visitors on slow network connections.
...
Visitors on slow connections benefit most from preloading. The preloaded page eliminates the delay that slow connections cause.
...
Visitors in regions with slower internet benefit from preloading the next page.

### Mobile users on 3G

3G connections cause significant page load delays. Preloading eliminates this delay.
