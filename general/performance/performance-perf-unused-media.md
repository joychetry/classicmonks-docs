...
slug: performance/perf-unused-media
...
author: Joy
reading_time: 3 min
canonical: https://classicmonks.com/docs/performance/perf-unused-media/
---

# How to Use the Unused Media Checker in WordPress

> Unused Media Checker in Classic Monks scans your Media Library for files that are not referenced in any post, page, or widget. Shows unused files for review and deletion.
...
Unused media files consume disk space and can bloat backups. Finding and removing them improves site performance and reduces hosting costs.
...
After a redesign or content migration, many files may be orphaned. The Unused Media Checker identifies them for cleanup.

### Backup optimization

Smaller media libraries mean smaller backups and faster restoration.
