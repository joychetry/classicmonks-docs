...
> Custom URL Preload Method in Classic Monks lets you manually specify which URLs to preload. Provides maximum control over the preloading behavior.
...
Automatic preloading is based on heuristics. Custom URL preloading lets you specify exactly which pages to preload, giving you full control.
...
Preload specific landing pages before visitors arrive from ads.

### Product launches

Preload product pages before a product launch to ensure instant page loads.
