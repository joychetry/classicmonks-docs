---
title: "How to Stop Preloading on Errors in WordPress | CM"
slug: performance/perf-preload-stop-errors
description: "Stop preloading when errors are detected in Classic Monks. Prevents preloading from continuing when errors occur."
last_updated: 2026-06-24
author: Joy
reading_time: 3 min
canonical: https://classicmonks.com/docs/performance/perf-preload-stop-errors/
---

# How to Stop Preloading on Errors in WordPress

> Stop Preloading on Errors in Classic Monks stops the preloading process when errors are detected, preventing wasted bandwidth and resources.
...
If preloading encounters errors (e.g., 404s, network failures), continuing to preload wastes bandwidth and can cause performance issues.
...
When a preloaded page returns an error, stopping preloading prevents further wasted requests.

### Network issues

On unstable connections, stopping preloading on errors prevents the browser from queuing too many failed requests.
