---
title: "How to Use Media Replacement in WordPress"
...
> Media Replacement in Classic Monks lets you replace a media file without breaking existing references. Upload a new file to replace an existing one, and all links are updated.
...
The default WordPress Media Library doesn't have a replace function. To replace a file, you'd need to manually update every reference to the old file. Media Replacement automates this.
...
When you update a logo, product image, or any media file, Media Replacement ensures all references across the site are updated.

### Fixing broken images

If an image file was accidentally deleted or corrupted, Media Replacement lets you upload a new file to fix all references.
