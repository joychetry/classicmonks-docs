...
> Lazy Render Videos in Classic Monks defers video element rendering until the video enters the viewport.
...
Video elements add rendering overhead. Lazy rendering defers this work until the video is visible.
...
Background video elements are rendered lazily, reducing initial rendering time.
