...
> Customize the WordPress login page in Classic Monks. Change the logo, background, form styling, and more.
...
This feature registers 3 WordPress hooks in `custom-login-page.php`:
