...
But ASE Pro still has important gaps:

- Custom Content Types, including CPTs, taxonomies, fields, and options pages
- Form Builder
- Full Site Backup and Migration
- General File Manager
- Deep Code Snippets Manager workflows and PHP safe mode
...
[Full comparison: ASE vs Classic Monks](https://classicmonks.com/docs/ase-vs-classic-monks/)
